...
/** Uma regra léxica: regex "sticky", que casa a partir da posição atual. */
...
/**
 * `classify` escolhe a heurística de reclassificação de identificadores:
 * 'c-like' usa contexto de declaração, 'sql' compara sem diferenciar caixa,
 * 'none' não reclassifica.
 */
export interface LanguageDef {
  readonly rules: readonly LexRule[];
  readonly keywords: ReadonlySet<string>;
  readonly builtins: ReadonlySet<string>;
  readonly classify: 'c-like' | 'python' | 'sql' | 'none';
}
